...
TRAIN_PERFORMANCE_METRICS_FILE_NAME = f"{selected_dataset}_{selected_model}_train_performance.json"
TRAIN_PERFORMANCE_METRICS_FILE_PATH = os.path.join(METRICS_PATH, TRAIN_PERFORMANCE_METRICS_FILE_NAME)
