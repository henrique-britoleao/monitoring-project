...
def main_modeling_from_name(X_train, y_train):
    """
    Main modeling function to fit a model on the training set using the best
    ...
    best_params, best_score = main_GS_from_estimator_and_params(
        X_train, y_train, estimator, params_grid
    )
